...
local MONITOR_1 = "DP-6"
local MONITOR_2 = "DP-5"
...
require("env")
-- Source: ~/.config/hypr/exec.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("exec")
